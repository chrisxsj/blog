 ...
 * pg�汾10.6
 * ʹ�÷�ʽ��
 * �滻Ŀ¼ ../postgresql-10.6/contrib/passwordcheck �µ� passwordcheck.c
 * ���밲װ make && make install
 * ����passwordcheck.so �滻$PGHOMEĿ¼�е��ļ����ɡ�
 * postgresql�����ļ����޸� (postgresql.conf)
...
/* 
 * �����ļ���passwordcheck.level='true' Ϊ��Ҫ�����ַ� 
 * passwordcheck.level='false' Ϊֻ��ҪӢ�ĺ�����
 */
static bool passwordcheck_level = true;
